...
public interface FollowRepository extends Neo4jRepository<Follow, String> {
    ...
    boolean existsByIdProfileFollowerAndIdProfileTarget(String idFollower , String idTarget);

    boolean existsByIdProfileTargetAndIdProfileFollower(String idTarget , String idFollower);
