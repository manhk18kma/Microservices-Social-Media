...
public class ProfileEventHandler {
   ...
   final FriendRepository friendRepository;
    ...
    public void on(ProfileCreateEvent profileCreateEvent){
        ...
        builder.idProfile(profileCreateEvent.getIdProfile());
        builder.fullName(profileCreateEvent.getFullName());
        builder.urlProfilePicture(profileCreateEvent.getUrlProfilePicture());
        builder.biography(profileCreateEvent.getBiography());
//        builder.gender(profileCreateEvent.getGender());
        builder.dateOfBirth(profileCreateEvent.getDateOfBirth());
        builder.updateAt(new Date());
        builder.idAccount(profileCreateEvent.getIdAccount());
        builder.friendShip(new HashSet<>());
